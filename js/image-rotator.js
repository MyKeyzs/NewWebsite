$(document).ready(function(){
	...
	$.timer(6000, function (timer) {
		...
		switch(current_panel){
			...
			break;
			case 2:
				$("#slideshow").stop().animate({left: "0px", top: "-450px"}, {easing: 'easeOutBack', duration: animation_duration});
				current_panel = 3;
			break;
			case 3:
				$("#slideshow").stop().animate({left: "-960px", top: "-450px"}, {easing: 'easeOutBack', duration: animation_duration});
				current_panel = 4;
			break;
			case 4:
